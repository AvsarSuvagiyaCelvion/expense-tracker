  ...
  return (
    <div className="card p-4 shadow-sm border-0">
      <div className="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-3 mb-4">
        ...
        <div className="d-flex flex-column flex-sm-row gap-2 col-12 col-md-8 justify-content-md-end">
          {/* Search Input */}
          <div className="search-wrapper flex-grow-1 animate-fade-in" style={{ maxWidth: '300px' }}>
